...
interface Screenshot {
  ...
  const EverBook = () => {
    ...
    const screenshots = [
      { url: "/images/everbook/1.webp", alt: t('everbook.screenshots.main') },
      { url: "/images/everbook/2.webp", alt: t('everbook.screenshots.detail') },
      { url: "/images/everbook/3.webp", alt: t('everbook.screenshots.settings') }
    ];
